...
class Zarinpal extends PortAbstract implements PortInterface
{
    ...
    protected function sendPayRequest()
    {
        ...
        $fields = [
            ...
            'Description' => $this->description ? $this->description : $this->gateway['description'],
            'Email'       => $this->email ? $this->email : $this->gateway['email'],
            'Mobile'      => $this->mobileNumber ? $this->mobileNumber : $this->gateway['mobile'],
        ];
